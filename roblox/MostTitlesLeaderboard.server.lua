...
-- CONFIG
local BOARD_PART_NAME = "Most Title Leaderboard" -- CASE + SPACE sensitive
local TITLE_TEXT = "Most Titles Collected"
local REFRESH_INTERVAL = 30
local MAX_ROWS = 10
local ORDERED_STORE_NAME = "GlobalMostTitlesCollectedLeaderboard_v1"

local TITLES = {
	{Id = "None", Name = "None", Required = 0},
	{Id = "IdleBeginner", Name = "Time Newbie", Required = 60},
	{Id = "AFKExplorer", Name = "Clock Rookie", Required = 300},
	{Id = "AFKRookie", Name = "Minute Stacker", Required = 1200},
	{Id = "AFKVeteran", Name = "Hour Holder", Required = 3600},
	{Id = "AFKGrinder", Name = "Drift Runner", Required = 7200},
	{Id = "AFKElite", Name = "Chrono Charger", Required = 10800},
	{Id = "AFKMaster", Name = "Day Dreamer", Required = 21600},
	{Id = "AFKTitan", Name = "Half-Day Howler", Required = 43200},
	{Id = "AFKLegend", Name = "24H Beast", Required = 86400},
	{Id = "ChronoSovereign", Name = "Storm of Seconds", Required = 172800},
	{Id = "Daybreaker", Name = "Clockbreaker X", Required = 259200},
	{Id = "Weeksmith", Name = "Temporal Overlord", Required = 345600},
	{Id = "Everclock", Name = "Paradox Reaper", Required = 432000},
	{Id = "InfinityWatch", Name = "Infinity Cataclysm", Required = 604800},
	{Id = "QuantumSleeper", Name = "Quantum Sleeper", Required = 777600},
	{Id = "EpochWarden", Name = "Epoch Warden", Required = 950400},
	{Id = "CalendarCrusher", Name = "Calendar Crusher", Required = 1209600},
	{Id = "MonthMarauder", Name = "Month Marauder", Required = 1814400},
	{Id = "TimeGlacier", Name = "Time Glacier", Required = 2419200},
	{Id = "EraArchitect", Name = "Era Architect", Required = 3024000},
	{Id = "MillenniumDrift", Name = "Millennium Drift", Required = 3628800},
	{Id = "CosmicClocklord", Name = "Cosmic Clocklord", Required = 4233600},
	{Id = "TimelineDevourer", Name = "Timeline Devourer", Required = 4838400},
	{Id = "AbsoluteEternity", Name = "Absolute Eternity", Required = 5443200},
	{Id = "Donater", Name = "Donater", Required = 0, RequiresDonation = true},
	{Id = "Disco", Name = "Disco", Required = 0, RequiresDiscoTitle = true},
	{Id = "PackComet", Name = "Comet Trail", Required = 0, RequiresPackTitle = "PackComet"},
	{Id = "PackAurora", Name = "Aurora Pulse", Required = 0, RequiresPackTitle = "PackAurora"},
	{Id = "PackNebula", Name = "Nebula Core", Required = 0, RequiresPackTitle = "PackNebula"},
	{Id = "PackCelestial", Name = "Celestial Crown", Required = 0, RequiresPackTitle = "PackCelestial"},
	{Id = "PackSingularity", Name = "GOD", Required = 0, RequiresPackTitle = "PackSingularity"},
	{Id = "Owner", Name = "Owner", Required = 0, AllowedUserIds = {3653999284}},
}
...
local function createBoardGui(boardPart)
	local existing = boardPart:FindFirstChild("MostTitlesLeaderboardGui")
	if existing then
		existing:Destroy()
	end

	local surfaceGui = Instance.new("SurfaceGui")
	surfaceGui.Name = "MostTitlesLeaderboardGui"
...
local function getCollectedTitlesCount(player)
	local secondsValue = getSeconds(player)
	local hasDonated = player:GetAttribute("HasDonated") == true
	local hasDiscoTitle = player:GetAttribute("HasDiscoTitle") == true
	local count = 0
	...
	for _, data in ipairs(TITLES) do
		...
		local unlocked = secondsValue >= data.Required
		if data.RequiresDonation then
			unlocked = hasDonated
		end
		if data.RequiresDiscoTitle then
			unlocked = hasDiscoTitle
		end
...
local function pushPlayerToGlobal(player)
	local titleCount = getCollectedTitlesCount(player)
	local ok, err = pcall(function()
		leaderboardStore:SetAsync(tostring(player.UserId), titleCount)
	end)
	if not ok then
		warn("[MostTitlesLeaderboard] Failed SetAsync for", player.UserId, err)
	end
end
...
local function createRow(parent, rank, userId, playerName, titleCount)
	...
	valueLabel.Position = UDim2.fromScale(0.7, 0.08)
	valueLabel.Size = UDim2.fromScale(0.29, 0.84)
	valueLabel.BackgroundTransparency = 1
	valueLabel.TextXAlignment = Enum.TextXAlignment.Right
	valueLabel.Text = tostring(titleCount) .. " Titles"
	valueLabel.Font = Enum.Font.FredokaOne
	valueLabel.TextScaled = true
	valueLabel.TextColor3 = Color3.fromRGB(255, 235, 130)
...
local function renderGlobalRows(rowsFrame)
	...
	if not ok then
		warn("[MostTitlesLeaderboard] Failed GetSortedAsync")
		return
	end
...
if not boardPart or not boardPart:IsA("BasePart") then
	warn("[MostTitlesLeaderboard] Missing BasePart named '" .. BOARD_PART_NAME .. "'")
	return
end
